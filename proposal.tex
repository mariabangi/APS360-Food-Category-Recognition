...
This task is challenging due to the large visual variation within food categories and contrarily, visual similarities between different categories. Variations in lighting, presentation, aesthetics and viewpoints complicate classification. Convolutional neural networks (CNN's) are suited for this due to strong performance on image classification by its ability to automatically learn significant visual features from raw pixel data given. This project will train and evaluate a CNN-based approach, which will be suitable and an effective method for food category recognition. Future integration of the model will be nutritional applications that will automatically identify food categories and calorie intake from user-uploaded images.
